...
Levels.setURL(`${config.MongoDB_TOKEN || process.env.MongoDB_TOKEN}`);
const lvlSchema = require(`${process.cwd()}/models/levelToggleSchema`);
        ...
        try {
            ...
            lvlSchema.findOne({
                ...
                if (data.toggle == 1) {
                    ...
                    if (hasLeveledUp) {
                        ...
                        if (channel) {
                                return channel.send({
                                    content: `${message.member}, لقد وصلت إلى **المستوى  ${user.level}!**  <a:level:1077329282084392972>`
                                }).catch(() => {});
                            } else {
            ...
            return message.channel.send({
                embeds: [new MessageEmbed()
                    ...
                    .setTitle(`<:x_:1077331927821979728> ERROR | An error occurred`)
