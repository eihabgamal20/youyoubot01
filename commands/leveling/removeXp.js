...
module.exports = {
  ...
  async execute(client, message, args, ee) {
    ...
    .setTitle(`Please mentions the member to remove Xp`)
    .setColor(`#df2b39`)] });
    ...
    .setTitle(` Please mention the amount of Xp you want to remove`)
    .setColor(`#df2b39`)] });
    try {
      await Levels.subtractXp(mentionmember.user.id, message.guild.id, value);
      message.reply({ embeds: [new MessageEmbed()
    .setTitle(` Removed: **${value}** Xp from **${mentionmember.user.tag}**`)
    .setColor(`#df2b39`)] })
    } catch (e) {
