...
module.exports = {
  ...
  async execute(client, message, args, ee) {
    ...
    .setTitle(`Please mentions the member to set Xp`)
    .setColor(`#df2b39`)] });
    ...
    .setTitle(`Please mention the amount of Levels you want to set`)
    .setColor(`#df2b39`)] });
    try {
      await Levels.setXp(mentionmember.user.id, message.guild.id, value);
      message.reply({ embeds: [new MessageEmbed()
    .setTitle(` Set: **${value}** Xp for **${mentionmember.user.tag}**`)
    .setColor("RED")] })
    } catch (e) {
